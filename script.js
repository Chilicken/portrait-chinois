...
analogies = ["", "un manga", "un oeuf", "un film d'action", "un film de super-héros", "une série humoristique", "un jeu-vidéo", "un objet"]
quoi = ["", "Chainsaw Man", "mollet", "Fist of Fury", "Spider-Man 2", "It's Always Sunny in Philadelphia", "Apex Legends", "des écouteurs"]
explication = ["", "le héros ne perd jamais ses objectifs de vue", "c'est le réconfort d'un oeuf à la coque avec le côté pratique d'un oeuf dur", "c'est mon film préféré de Bruce <br> Lee, le meilleur acteur de film d'arts martiaux", "Peter Parker finit toujours par se relever malgré les difficultés qu'il rencontre", "le visionnage de cette série ne nécessite pas plus de 3 de QI", "c'est le jeu-vidéo qui me donne le plus d'adrénaline", "cela permet de se relaxer comme de se concentrer pour travailler"]
